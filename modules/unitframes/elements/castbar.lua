...
function ns.AddCastBar(self, unit)
	...
	local cbborder = CreateFrame("Frame", nil, self, BackdropTemplateMixin and "BackdropTemplate")
	...
	local iconborder = CreateFrame("Frame", nil, self, BackdropTemplateMixin and "BackdropTemplate")
